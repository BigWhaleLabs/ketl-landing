export default function () {
  return (
    <svg
      ...
      class="download-btn"
      enable-background="new -237.1 377.9 133.1 38.2"
      role="img"
      version="1.1"
      viewBox="-237.1 377.9 133.1 38.2"
      x="0px"
      xmlSpace="preserve"
    ...
    >
      <g fill="currentColor">
        <path
          d="M-157.1,389.6c0.2-0.1,0.3-0.3,0.4-0.6c0-0.1,0-0.1,0-0.2v-0.7c-1.2,0-1.7,0.3-1.7,1c0,0.2,0.1,0.4,0.2,0.6
      s0.3,0.2,0.5,0.2C-157.5,389.8-157.3,389.7-157.1,389.6z"
        ></path>
        <path
          d="M-167,400.4c-0.5,0-1,0.2-1.4,0.5c-0.4,0.3-0.7,0.8-0.8,1.4c-0.1,0.3-0.1,0.5-0.1,0.6v1.6c0,0.7,0.2,1.3,0.6,1.8
      ...
      "
        ></path>
        <path
          d="M-163,386.4c-0.4,0-0.7,0.2-1,0.6c-0.2,0.3-0.3,0.7-0.3,1.1c0,0.4,0.1,0.8,0.3,1.1c0.2,0.4,0.5,0.6,1,0.6
      c0.4,0,0.7-0.2,0.9-0.6c0.2-0.3,0.3-0.7,0.3-1.1s-0.1-0.8-0.3-1.1C-162.3,386.6-162.6,386.4-163,386.4z"
        ></path>
        <path
          d="M-185.4,386.4c-0.4,0-0.7,0.2-1,0.6c-0.2,0.3-0.3,0.7-0.3,1.1c0,0.4,0.1,0.8,0.3,1.1c0.2,0.4,0.5,0.6,1,0.6
      c0.4,0,0.7-0.2,0.9-0.6c0.2-0.3,0.3-0.7,0.3-1.1s-0.1-0.8-0.3-1.1C-184.7,386.6-185,386.4-185.4,386.4z"
        ></path>
        <path
          d="M-178,400.4c-0.5,0-1,0.2-1.4,0.5c-0.4,0.3-0.7,0.8-0.8,1.4c-0.1,0.3-0.1,0.5-0.1,0.6v1.6c0,0.7,0.2,1.3,0.6,1.8
      ...
      "
        ...
        <path
          d="M-190.7,389c0.4-0.4,0.7-1.1,0.7-1.9c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-1-0.6-1.8-0.6c-0.3,0-0.6,0-0.8,0.1v4.9
      c0.1,0,0.4,0,0.7,0C-191.8,389.7-191.1,389.4-190.7,389z"
        ></path>
        <path
          d="M-151.2,386.7c-0.2-0.2-0.4-0.3-0.7-0.3c-0.4,0-0.7,0.2-0.9,0.5c-0.2,0.3-0.3,0.7-0.3,1.2c0,0.5,0.1,0.8,0.3,1.1
      c0.2,0.3,0.5,0.5,0.9,0.5c0.3,0,0.6-0.1,0.8-0.4c0.2-0.2,0.3-0.5,0.3-0.9v-0.8c0-0.1,0-0.2,0-0.3
      C-150.9,387.1-151,386.9-151.2,386.7z"
        ></path>
        <path
          d="M-118.3,401.1c-0.4-0.6-0.9-0.9-1.7-0.9c-0.7,0-1.3,0.3-1.7,0.9c-0.4,0.5-0.6,1-0.6,1.7h4.4
      C-117.9,402.1-118,401.5-118.3,401.1z"
        ></path>
        <path
          d="M-137,400.3c-0.9,0-1.5,0.4-2,1.1c-0.4,0.6-0.6,1.4-0.6,2.3c0,0.9,0.2,1.6,0.6,2.3c0.5,0.8,1.1,1.1,1.9,1.1
      c0.8,0,1.5-0.4,1.9-1.2c0.4-0.6,0.6-1.4,0.6-2.3c0-0.9-0.2-1.6-0.6-2.3C-135.5,400.7-136.2,400.3-137,400.3z"
        ></path>
        <path
          d="M-104,381.7c0-2.1-1.7-3.8-3.8-3.8h-125.5c-2.1,0-3.8,1.7-3.8,3.8v30.5c0,2.1,1.7,3.8,3.8,3.8h125.5c2.1,0,3.8-1.7,3.8-3.8
      ...
      c0.8-1,1.9-1.5,3.4-1.5c1.4,0,2.4,0.5,3.1,1.5c0.6,0.8,0.8,1.8,0.8,3C-115.8,403.6-115.9,404-115.9,404.2z"
        ></path>
        <path
          d="M-143.1,389.8c0.4,0,0.7-0.2,0.9-0.6c0.2-0.3,0.3-0.7,0.3-1.1s-0.1-0.8-0.3-1.1c-0.2-0.4-0.5-0.6-0.9-0.6
      c-0.4,0-0.7,0.2-1,0.6c-0.2,0.3-0.3,0.7-0.3,1.1c0,0.4,0.1,0.8,0.3,1.1C-143.8,389.6-143.5,389.8-143.1,389.8z"
        ></path>
        <path
          d="M-118,386.8c-0.2-0.3-0.5-0.4-0.8-0.4c-0.3,0-0.6,0.1-0.8,0.4c-0.2,0.2-0.3,0.5-0.3,0.8h2.2
      C-117.8,387.3-117.9,387-118,386.8z"
        ></path>
      </g>
    </svg>
  )
